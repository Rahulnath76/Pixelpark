            ...
            <nav className="bg-white border-gray-200 px-4 lg-px-6 py-2.5">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center lg:order-2">
                            <Link to="/login" className="text-gray-700 hover:bg-gray-100 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg  text-base px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none">Log in</Link>
